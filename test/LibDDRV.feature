Feature: Dynamic Discrete Random Variates
    ...
    # Insert (basic -- see Update scenarios for more expressive Insert scenarios)
    ...
    Scenario: TODO Insert 1 Element 10 times
    ...
    Background: Forest with 11 Elements, 3 Root Ranges, 2 Levels, and total weight of 100
        ...
        And The weight of Range R₃⁽¹⁾ is 25
        And The weight of Range R₄⁽¹⁾ is 55
        And The weight of Range R₅⁽¹⁾ is 20
        And The weight of Range R₅⁽²⁾ is 25
        And The weight of Range R₆⁽²⁾ is 55
    ...
    Scenario: F -- Update 1 Element, decrease weight, moves to lower range numbered-parent, 1 grandparent dies, 1 Level is added
        ...
        And The weight of Range R₃⁽¹⁾ should be 32
        And The weight of Range R₄⁽¹⁾ should be 40
        And The weight of Range R₅⁽¹⁾ should still be 20
    ...
    Scenario: I -- Update 2 Elements, increase weight, moves to higher range numbered-grandparent, no change in parent
        ...
        And The weight of Range R₃⁽¹⁾ should still be 25
    ...
    Scenario: M -- Update 1 Element, increase weight, jump across parents, 1 Level is added
        When I update Element 5 from weight 5 to weight 30

        Then The parent of Element 5 should be Range R₅⁽¹⁾

        And The total weight of the Forest should be 125

        And There should still be 2 Levels in the Forest
        And The weight of Level 1 should be 0
        And The weight of Level 2 should be 20
        And The weight of Level 3 should be 105

        And The weight of Range R₃⁽¹⁾ should be 20
        And The weight of Range R₄⁽¹⁾ should be 55
        And The weight of Range R₅⁽¹⁾ should be 50
        And The weight of Range R₅⁽²⁾ should be 20
        And The weight of Range R₆⁽²⁾ should be 105
        And The weight of Range R₇⁽³⁾ should be 105
        ...
        And The Forest should have the following structure:
            ...
            | 7       | 5        | R₃⁽¹⁾  | (20)     | R₅⁽²⁾       | 20        |                  |            |
            | 8       | 5        | R₃⁽¹⁾  | (20)     | R₅⁽²⁾       | 20        |                  |            |
            | 1       | 10       | R₄⁽¹⁾  | (55)     | R₆⁽²⁾       | (105)     | R₇⁽³⁾            | 105        |
            | 3       | 15       | R₄⁽¹⁾  | (55)     | R₆⁽²⁾       | (105)     | R₇⁽³⁾            | 105        |
            | 9       | 10       | R₄⁽¹⁾  | (55)     | R₆⁽²⁾       | (105)     | R₇⁽³⁾            | 105        |
            | 10      | 10       | R₄⁽¹⁾  | (55)     | R₆⁽²⁾       | (105)     | R₇⁽³⁾            | 105        |
            | 11      | 10       | R₄⁽¹⁾  | (55)     | R₆⁽²⁾       | (105)     | R₇⁽³⁾            | 105        |
            | 4       | 20       | R₅⁽¹⁾  | (50)     | R₆⁽²⁾       | (105)     | R₇⁽³⁾            | 105        |
            | 5       | 30 *     | R₅⁽¹⁾  | (50)     | R₆⁽²⁾       | (105)     | R₇⁽³⁾            | 105        |

    Scenario: N -- Update 2 Elements, increase weight, jump across parents, 1 grandparent dies, 1 switches, 1 is born
        When I update Element 5 from weight 5 to weight 30
        And I update Element 7 from weight 5 to weight 10

        Then The parent of Element 5 should now be Range R₅⁽¹⁾
        And The parent of Element 7 should now be Range R₄⁽¹⁾

        And The total weight of the Forest should be 130

        And There should still be 2 Levels in the Forest
        And The weight of Level 1 should be 0
        And The weight of Level 2 should be 130
    ...
    Scenario: O -- TODO 4 Levels
    - Insert Element 12 with weight 30
    - Parent should R₅⁽¹⁾ with weight 50
    - Grandparent should be R₆⁽²⁾ with weight XYZ
    - Great Grandparent should be R₇⁽³⁾ with weight XYZ

    Scenario: P -- "Delete" 1 Element, 1 parent dies, 1 grandparent dies
        When I update Element 5 weight from 5 to weight 0

        Then The parent of Element 5 should be the null Range R₀⁽¹⁾

        And The total weight of the forest should be 95

        And There should be 2 Levels in the Forest
        And The weight of Level 1 should still be 20
        And The weight of Level 2 should be 75
    ...
    Scenario: Q -- TODO "Delete" n Elements, decrease parent

    Scenario: R -- TODO "Delete" n Elements, increase parent

    # Generate

    Scenario: Generate discrete random variate from set of 100 Elements
        Given The Forest contains the following 5 Elements:
            ...
            | 4       | 12     |
            | 5       | 41     |
        When I generate 10,000 discrete random variates
        Then The instances of each Element being selected should be the following, within 10% tolerance:
            | Element | Instances |
            | 1       | 3800      |
            | 2       | 400       |
            | 3       | 500       |
